...
type FormInputComponentProps<T extends z.Schema> = {
  children?: ReactNode;
} & (Omit<FormInputProps<z.infer<T>>, "children"> | Omit<PhoneFormInputProps<z.infer<T>>, "children">);
...
export const FormInput = forwardRef(
  <T extends z.Schema>(
    ...
    return (
      <>
        {props.phoneInput ? (
          <PhoneInput className={twJoin(fieldState.error && "border-red", className)} {...field} {...props} ref={ref}>
            {children}
          </PhoneInput>
        ) : (
          <Input {...field} className={twJoin(fieldState.error && "border-red", className)} {...props} ref={ref}>
            {children}
          </Input>
        )}
      </>
