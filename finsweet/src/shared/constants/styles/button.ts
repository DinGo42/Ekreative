export enum ButtonStyleTypes {
  MAIN = 'p-3 pl-9 pr-9 bg-yellow-90 rounded-4xl text-lb-1 text-blue-400 hover:text-blue-950 hover:bg-yellow-200',
  SECONDARY = 'p-3 pl-9 pr-9 bg-blue-1000 rounded-4xl text-lb-1 text-white-1000 hover:bg-blue-300',
