...
const config: Config = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      [FontSizes.MEDIUM_SECONDARY]: ["16px", { fontWeight: 300, lineHeight: "22px" }],
      [FontSizes.MEDIUM_MAIN]: ["13px", { fontWeight: 400, lineHeight: "18px" }],
      [FontSizes.SMALL_SECONDARY]: ["12px", { fontWeight: 300, lineHeight: "16px" }],
      [FontSizes.MEDIUM_MAIN_SECONDARY]: ["14px", { fontWeight: 400, lineHeight: "20px" }],
      [FontSizes.LARGE_MAIN_SECONDARY]: ["18px", { fontWeight: 400, lineHeight: "28px" }],
