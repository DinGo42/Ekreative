export const countryNumberCodesData = [
  { code: 'AC', label: 'Ascension Island', phone: '247', phoneLength: 0 },
  ...
  { code: 'AG', label: 'Antigua and Barbuda', phone: '1', phoneLength: 10 },
  { code: 'AI', label: 'Anguilla', phone: '1', phoneLength: 10 },
  { code: 'AL', label: 'Albania', phone: '355', phoneLength: 9 },
  { code: 'AM', label: 'Armenia', phone: '374', phoneLength: 8 },
  { code: 'AO', label: 'Angola', phone: '244', phoneLength: 9 },
  { code: 'AR', label: 'Argentina', phone: '54', phoneLength: 13 },
  { code: 'AS', label: 'American Samoa', phone: '1', phoneLength: 10 },
  ...
  { code: 'BL', label: 'Saint Barthélemy', phone: '590', phoneLength: 12 },
  { code: 'BM', label: 'Bermuda', phone: '1', phoneLength: 10 },
  { code: 'BN', label: 'Brunei', phone: '673', phoneLength: 8 },
  { code: 'BO', label: 'Bolivia', phone: '591', phoneLength: 8 },
  { code: 'BQ', label: 'Caribbean Netherlands', phone: '599', phoneLength: 7 },
  { code: 'BR', label: 'Brazil', phone: '55', phoneLength: 13 },
  { code: 'BS', label: 'Bahamas', phone: '1', phoneLength: 10 },
  { code: 'BT', label: 'Bhutan', phone: '975', phoneLength: 8 },
  ...
  { code: 'CC', label: 'Cocos (Keeling) Islands', phone: '61', phoneLength: 9 },
  { code: 'CD', label: 'Congo (DRC)', phone: '243', phoneLength: 9 },
  {
    code: 'CF',
  ...
  { code: 'CH', label: 'Switzerland', phone: '41', phoneLength: 12 },
  { code: 'CI', label: 'Côte d’Ivoire', phone: '225', phoneLength: 8 },
  { code: 'CK', label: 'Cook Islands', phone: '682', phoneLength: 5 },
  { code: 'CL', label: 'Chile', phone: '56', phoneLength: 12 },
  ...
  { code: 'CW', label: 'Curaçao', phone: '599', phoneLength: 7 },
  ...
  { code: 'DE', label: 'Germany', phone: '49', phoneLength: 13 },
  { code: 'DJ', label: 'Djibouti', phone: '253', phoneLength: 8 },
  { code: 'DK', label: 'Denmark', phone: '45', phoneLength: 8 },
  { code: 'DM', label: 'Dominica', phone: '1', phoneLength: 10 },
  { code: 'DO', label: 'Dominican Republic', phone: '1', phoneLength: 10 },
  ...
  { code: 'FI', label: 'Finland', phone: '358', phoneLength: 12 },
  { code: 'FJ', label: 'Fiji', phone: '679', phoneLength: 7 },
  { code: 'FK', label: 'Falkland Islands', phone: '500', phoneLength: 5 },
  { code: 'FM', label: 'Micronesia', phone: '691', phoneLength: 7 },
  { code: 'FO', label: 'Faroe Islands', phone: '298', phoneLength: 7 },
  { code: 'FR', label: 'France', phone: '33', phoneLength: 11 },
  { code: 'GA', label: 'Gabon', phone: '241', phoneLength: 7 },
  { code: 'GB', label: 'United Kingdom', phone: '44', phoneLength: 11 },
  { code: 'GD', label: 'Grenada', phone: '1', phoneLength: 10 },
  { code: 'GE', label: 'Georgia', phone: '995', phoneLength: 9 },
  { code: 'GF', label: 'French Guiana', phone: '594', phoneLength: 9 },
  { code: 'GG', label: 'Guernsey', phone: '44', phoneLength: 11 },
  ...
  { code: 'GP', label: 'Guadeloupe', phone: '590', phoneLength: 12 },
  { code: 'GQ', label: 'Equatorial Guinea', phone: '240', phoneLength: 8 },
  { code: 'GR', label: 'Greece', phone: '30', phoneLength: 10 },
  { code: 'GT', label: 'Guatemala', phone: '502', phoneLength: 8 },
  { code: 'GU', label: 'Guam', phone: '1', phoneLength: 10 },
  { code: 'GW', label: 'Guinea-Bissau', phone: '245', phoneLength: 7 },
  { code: 'GY', label: 'Guyana', phone: '592', phoneLength: 8 },
  ...
  { code: 'IM', label: 'Isle of Man', phone: '44', phoneLength: 11 },
  ...
  { code: 'IT', label: 'Italy', phone: '39', phoneLength: 12 },
  { code: 'JE', label: 'Jersey', phone: '44', phoneLength: 11 },
  { code: 'JM', label: 'Jamaica', phone: '1', phoneLength: 10 },
  ...
  { code: 'KN', label: 'Saint Kitts and Nevis', phone: '1', phoneLength: 10 },
  { code: 'KP', label: 'North Korea', phone: '850', phoneLength: 9 },
  { code: 'KR', label: 'South Korea', phone: '82', phoneLength: 10 },
  { code: 'KW', label: 'Kuwait', phone: '965', phoneLength: 8 },
  { code: 'KY', label: 'Cayman Islands', phone: '1', phoneLength: 10 },
  { code: 'KZ', label: 'Kazakhstan', phone: '7', phoneLength: 11 },
  { code: 'LA', label: 'Laos', phone: '856', phoneLength: 10 },
  { code: 'LB', label: 'Lebanon', phone: '961', phoneLength: 8 },
  { code: 'LC', label: 'Saint Lucia', phone: '1', phoneLength: 10 },
  { code: 'LI', label: 'Liechtenstein', phone: '423', phoneLength: 8 },
  { code: 'LK', label: 'Sri Lanka', phone: '94', phoneLength: 9 },
  { code: 'LR', label: 'Liberia', phone: '231', phoneLength: 7 },
  ...
  { code: 'MD', label: 'Moldova', phone: '373', phoneLength: 8 },
  { code: 'ME', label: 'Montenegro', phone: '382', phoneLength: 9 },
  { code: 'MF', label: 'Saint Martin', phone: '590', phoneLength: 9 },
  { code: 'MG', label: 'Madagascar', phone: '261', phoneLength: 9 },
  { code: 'MH', label: 'Marshall Islands', phone: '692', phoneLength: 7 },
  { code: 'MK', label: 'North Macedonia', phone: '389', phoneLength: 8 },
  ...
  { code: 'MO', label: 'Macau', phone: '853', phoneLength: 8 },
  {
    code: 'MP',
  ...
  { code: 'MS', label: 'Montserrat', phone: '1', phoneLength: 10 },
  ...
  { code: 'MX', label: 'Mexico', phone: '52', phoneLength: 13 },
  ...
  { code: 'NF', label: 'Norfolk Island', phone: '672', phoneLength: 5 },
  ...
  { code: 'PE', label: 'Peru', phone: '51', phoneLength: 12 },
  ...
  { code: 'RU', label: 'Russia', phone: '7', phoneLength: 11 },
  ...
  { code: 'SE', label: 'Sweden', phone: '46', phoneLength: 10 },
  { code: 'SG', label: 'Singapore', phone: '65', phoneLength: 8 },
  { code: 'SH', label: 'Saint Helena', phone: '290', phoneLength: 5 },
  ...
  { code: 'ST', label: 'São Tomé and Príncipe', phone: '239', phoneLength: 7 },
  { code: 'SV', label: 'El Salvador', phone: '503', phoneLength: 8 },
  { code: 'SX', label: 'Sint Maarten', phone: '1', phoneLength: 10 },
  { code: 'SY', label: 'Syria', phone: '963', phoneLength: 10 },
  { code: 'SZ', label: 'Eswatini', phone: '268', phoneLength: 8 },
  { code: 'TA', label: 'Tristan da Cunha', phone: '', phoneLength: 0 },
  {
    code: 'TC',
  ...
  { code: 'TK', label: 'Tokelau', phone: '690', phoneLength: 4 },
  ...
  { code: 'TT', label: 'Trinidad and Tobago', phone: '1', phoneLength: 10 },
  { code: 'TV', label: 'Tuvalu', phone: '688', phoneLength: 5 },
  { code: 'TW', label: 'Taiwan', phone: '886', phoneLength: 9 },
  { code: 'TZ', label: 'Tanzania', phone: '255', phoneLength: 10 },
  ...
  { code: 'VA', label: 'Vatican City', phone: '379', phoneLength: 10 },
  {
    code: 'VC',
  ...
  { code: 'VG', label: 'British Virgin Islands', phone: '1', phoneLength: 10 },
  { code: 'VI', label: 'U.S. Virgin Islands', phone: '1', phoneLength: 10 },
  { code: 'VN', label: 'Vietnam', phone: '84', phoneLength: 9 },
  { code: 'VU', label: 'Vanuatu', phone: '678', phoneLength: 7 },
  { code: 'WF', label: 'Wallis and Futuna', phone: '681', phoneLength: 6 },
  { code: 'WS', label: 'Samoa', phone: '685', phoneLength: 7 },
  { code: 'XK', label: 'Kosovo', phone: '383', phoneLength: 9 },
...
export const pnoneNumbersMask: Record<
  number,
  { mask: string; placeholder: string }
> = {
  6: { mask: '999999', placeholder: ' 456789' },
  7: { mask: '999-99999', placeholder: '456-7890' },
  8: { mask: '999-999999', placeholder: '456-78901' },
  9: { mask: '99-999-99-99', placeholder: '45-678-90-12' },
  10: { mask: '(99)9-9999999', placeholder: '(45)6-7890123' },
  11: { mask: '(999)-9999999', placeholder: '(456)-789012' },
};

export const Coutries = countryNumberCodesData.map(({ code }) => code);
