...
export enum ButtonStyleTypes {
  ...
  ROUNDED_SQUARE = 'max-tabletS:h-10 max-tabletS:w-10 max-tabletS:border-[1px] border-[#D0D5DD] items-center justify-center flex rounded-lg gap-3 flex items-center',
  NONE = '',
}
