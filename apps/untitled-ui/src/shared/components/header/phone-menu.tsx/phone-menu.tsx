...
export const PhoneMenu: FC = () => {
  return (
    ...
    >
      <Link href={Routes.HOME} className="border-b-[1px] border-gray-200 p-2">
        Home
      </Link>
      <DropDown
        buttonTitle="Products"
        buttonProps={{
          className: "p-2 flex justify-between items-center gap-10 w-full border-b-[1px] border-gray-200",
        }}
      ...
      <Link href={Routes.HOME} className="border-t-[1px] border-gray-200 p-3">
        Pricing
      </Link>
    </DropDown>
  );
